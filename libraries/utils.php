...
//render('article/show')
function render(string $path, array $variables = [])  // variables $articles et $commentaires non reconnues à l'extérieur: créer un tableau associatif de variable qui par défaut sera un tableau vide
                                                      // à chaque appel de la "function render", donner le fichier à afficher + donner un tableau dans lequel on va identifier les variables nécessaires (cf article.php)
{
